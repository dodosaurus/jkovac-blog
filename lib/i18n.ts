...
export const copy = {
  sk: {
    ...
    articles: "Články",
    about: "O mne",
    heroKicker: "Poznámky / eseje / projekty",
    heroTitle: "Píšem o softvéri, AI a farmácii.",
    latest: "Najnovšie",
    read: "Čítať článok",
    minutes: "min čítania",
    aboutKicker: "O mne",
    ...
    footer: "Písané a tvorené v Bratislave.",
    contents: "Obsah",
  ...
  en: {
    ...
    articles: "Articles",
    about: "About",
    heroKicker: "Notes / essays / projects",
    heroTitle: "I write about software, AI and pharmacy.",
    latest: "Latest",
    read: "Read article",
    minutes: "min read",
    aboutKicker: "About",
    ...
    footer: "Written and built in Bratislava.",
    contents: "Contents",
